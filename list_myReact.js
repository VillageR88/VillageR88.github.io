...
const response = await fetch("Scripts/myReact.txt");
const text = await response.text();
const lines = text.split('\n');
const fileContentElement = document.getElementById('fileContent1b');
...
lines.forEach((line) => {
    ...
    a.addEventListener('click', (event) => {
        ...
        const url = `https://raw.githubusercontent.com/VillageR88/Codewars/main/React/${originalName}`;
